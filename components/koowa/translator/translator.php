 ...
 */
final class ComKoowaTranslator extends ComKoowaTranslatorAbstract implements KObjectInstantiable, KObjectSingleton
{
    /**
    ...
    {
        return $this->translateParameters(translate($string, $domain), $parameters);
    }
}